namespace MobilePackageGen
{
    internal class DevicePathUtils
    {
        ...
        internal static string FormatDevicePath(string DevicePath)
        {
        ...
        internal static string FormatDevicePath(Guid DevicePath)
        {
            return FormatDevicePath($"VenHw({DevicePath})");
        }
