...
namespace Microsoft.Deployment.Compression.Cab
{
    internal class CabPacker : CabWorker
    {
        ...
        {
            Erf.Clear();
            _ = NativeMethods.FCI.FlushFolder(fciHandle, fciGetNextCabinet, fciCreateStatus);
            CheckError(false);
        }
        ...
        {
            Erf.Clear();
            _ = NativeMethods.FCI.FlushCabinet(fciHandle, false, fciGetNextCabinet, fciCreateStatus);
            CheckError(false);
        }
        ...
        {
            NativeMethods.FCI.CCAB nextCcab = new();
