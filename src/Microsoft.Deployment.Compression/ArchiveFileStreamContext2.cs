...
namespace Microsoft.Deployment.Compression
{
    ...
    /// </remarks>
    public class ArchiveFileStreamContext2
        : IPackStreamContext, IUnpackStreamContext
    {
        ...
        /// <summary>
        /// Creates a new ArchiveFileStreamContext2 with a archive file and
        ...
        public ArchiveFileStreamContext2(string archiveFile)
            : this(archiveFile, null, null)
        {
        }

        /// <summary>
        /// Creates a new ArchiveFileStreamContext2 with a archive file, default
        ...
        /// <summary>
        /// Creates a new ArchiveFileStreamContext2 with a list of archive files,
        ...
        /// see <see cref="OpenFileReadStream"/> and <see cref="OpenFileWriteStream"/>.
        /// </remarks>
        public IDictionary<string, (Stream, FileAttributes, DateTime)> Files
        {
            get
            {
                return files;
        ...
        {
            (Stream, FileAttributes, DateTime) filePath = files[path];

            attributes = filePath.Item2;
            lastWriteTime = filePath.Item3;
            return filePath.Item1;
        }
